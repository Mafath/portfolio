...
// const AboutMe = () => {
//   return (
//     // <div id="about" className="relative bg-[#111421] text-gray-300 px-6 md:px-28 py-20 flex flex-col md:flex-row items-center justify-between gap-16">
//     <div id="about" className="relative text-gray-300 px-6 md:px-28 py-20 flex flex-col md:flex-row items-center justify-between gap-16 overflow-hidden bg-[#0b0f19]">
//     {/* <div id="about" className="relative bg-[#0b0f19]  overflow-hidden  "> */}
...
//         <p className="about-text text-base leading-relaxed mb-6">
...
//       {/* Right (Narrower) Animated Bubble */}
